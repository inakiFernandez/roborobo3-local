...
#ifndef SOCIALBEHAVIORCONTROLLER_H
#define SOCIALBEHAVIORCONTROLLER_H
...
class SocialBehaviorController : public Controller
{
private:
    int _iteration;
...
public:
    ...
    SocialBehaviorController(RobotWorldModel *wm);
