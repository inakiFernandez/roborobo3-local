...
SocialBehaviorAgentObserver::SocialBehaviorAgentObserver( RobotWorldModel *wm )
{
    _wm = (RobotWorldModel*)wm;
    
}

SocialBehaviorAgentObserver::~SocialBehaviorAgentObserver()
{
    // nothing to do.
}

void SocialBehaviorAgentObserver::reset()
{
    // nothing to do.
}

void SocialBehaviorAgentObserver::step()
{
