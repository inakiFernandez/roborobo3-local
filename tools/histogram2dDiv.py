# -*- coding: utf-8 -*-
"""
Created on Sat Apr 21 20:33:46 2018
...
if __name__ == "__main__":
    ...
    print(y.size)
    print()
    #plt.hist2d(sorted(x),sorted(y), bins=50)
    colormap = plt.cm.viridis_r
    #colormap = LinearSegmentedColormap.from_list('viridis', cm_data)
    #viridis_r_cm = matplotlib.colors.LinearSegmentedColormap(
    #'viridis_r', matplotlib.cm.revcmap(colormap._segmentdata))
    #colormap = viridis_r_cm   
    print(colormap)
    #colormap = ListedColormap(colormap.colors[::-1])
    #axis.set_ylim(ymax=maxY)
    #axis.set_xlim(xmax=maxX)
    print(maxX," ", maxY)
    maxBoth = np.max([maxX,maxY])
